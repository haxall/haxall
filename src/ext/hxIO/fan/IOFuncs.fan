...
//////////////////////////////////////////////////////////////////////////
  ...
  **
  ** Also see [ioStreamCsv()], [ioEachCsv()], [ioWriteCsv()], and [ph.doc::Csv].
  @Api @Axon { admin = true }
  ...
  **   - delimiter: separator char as string, default is ","
  **
  ** Also [ioReadCsv()], [ioWriteCsv()], and [ph.doc::Csv].
  @Api @Axon { admin = true }
  ...
  **
  ** Also [ioReadCsv()], [ioEachCsv()], and [ph.doc::Csv].
  @Api @Axon { admin = true }
...
//////////////////////////////////////////////////////////////////////////
  ...
  **   - `fandoc`: render string as [fandoc](fan.fandoc::pod-doc)
...
//////////////////////////////////////////////////////////////////////////
  ...
  ** looked up by the folllowing case sensitive key (raises exception
  ** if not found):
  **
  **     <scheme>://<host>[:<port>]/ <header-name>
  **
