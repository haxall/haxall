...
//////////////////////////////////////////////////////////////////////////
  ...
  **
  ...
  internal static IOHandle fromUri(Runtime rt, Uri uri)
  {
    ...
    return FileHandle(rt.sys.file.resolve(uri))
  }

  ** Get an IOHandle from a Dict rec
  internal static IOHandle fromDict(Runtime rt, Dict rec)
  {
...
{
  new make(Runtime rt, Uri uri) { this.rt = rt; this.uri = uri }
  const Runtime rt
  const Uri uri
