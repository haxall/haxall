...
//////////////////////////////////////////////////////////////////////////
  ...
  ** This func will throw an error if an entry with the given alias already exists.
  ...
  static Obj? cryptoGenSelfSignedCert(Str alias, Str subjectDn, Dict opts := Etc.dict0)
  {
    ...
    ext.setKey(alias, keys.priv, [cert])
...
//////////////////////////////////////////////////////////////////////////
  ...
  ** Convenience
  private static CryptoExt ext() { (CryptoExt)Context.cur.sys.crypto }
  ...
  static Grid cryptoLocal(Str? type)
  {
    ...
    switch(type)
    {
      ...
      case "cryptoEstManaged":  f = "estManaged"
      case "all":
  ...
  ** Can also trust a single certificate if no priv key is supplied.
  ...
  static Obj? cryptoAddCert(Str alias, Str pem, Bool force := false)
  {
    ...
    else
    {
      ...
      ext.setKey(alias, privKey, chain)
    }
    return alias
  }
  ...
  internal static Dict? entryToRow(Obj entry, Str? alias := null)
  {
    ...
    if (entry is PrivKeyEntry)
    {
      ...
      if (attrs.containsKey(CryptoEst.sfEstAttrOid))
        tags["estManaged"] = (Dict)ZincReader(((Str)attrs[CryptoEst.sfEstAttrOid]).in).readVal
    }
