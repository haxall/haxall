...
//////////////////////////////////////////////////////////////////////////
  ...
  ** as a [filter](doc.xeto::Filters) such as "site and area > 1000" then it
...
//////////////////////////////////////////////////////////////////////////
  ...
  ** a separate axis enforced at call time.
  ...
  static Void openapi()
  {
    ...
    out := res.out
    ex := OpenApiExporter(cx.ns, out, Etc.dict4("format", "json", "title", "$cx.rt.name API", "siteUri", cx.sys.http.siteUri, "projName", cx.rt.name))
    ex.start
