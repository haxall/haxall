...
//////////////////////////////////////////////////////////////////////////
  ...
  ** The format of this grid is subject to change.
  ...
  static Grid tasks(Dict? opts := null)
  {
    ...
    if (cx.feedIsEnabled) cx.feedAdd(TasksFeed(cx, lib, search), meta)
...
//////////////////////////////////////////////////////////////////////////
  ...
  ** White-box testing for adjunct
  ...
  {
    TestTaskAdjunct a := curContext.rt.exts.task.adjunct |->TestTaskAdjunct| { TestTaskAdjunct() }
    a.counter.increment
  ...
  ** Lookup TaskExt for context
  private static TaskExt lib(Context cx) { cx.ext("hx.task") }
}
