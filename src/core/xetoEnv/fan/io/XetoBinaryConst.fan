...
mixin XetoBinaryConst
{
  ...
  static const Int ctrlSpan          := 27
  static const Int ctrlVersion       := 28
  static const Int ctrlCoord         := 29
  static const Int ctrlGenericScalar := 30
  static const Int ctrlTypedScalar   := 31
}
