...
{
  new make(FileLoc loc, XetoLib lib, Str qname, Str name, XetoSpec? base, XetoSpec self, Dict meta, Dict metaOwn, MSlots slots, MSlots slotsOwn, Int flags, MSpecArgs args, SpecBinding binding)
