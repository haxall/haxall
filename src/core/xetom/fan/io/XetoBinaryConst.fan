...
mixin XetoBinaryConst
{
  ...
  static const Int ctrlRefNoDis      := 17
  static const Int ctrlUri           := 18
  static const Int ctrlDate          := 19
  static const Int ctrlTime          := 20
  static const Int ctrlDateTime      := 21
  static const Int ctrlBuf           := 22
  static const Int ctrlGenericScalar := 23
  static const Int ctrlTypedScalar   := 24
  static const Int ctrlEmptyDict     := 25
  static const Int ctrlNameDict      := 26
  static const Int ctrlGenericDict   := 27
  static const Int ctrlTypedDict     := 28
  static const Int ctrlSpecRef       := 29
  static const Int ctrlList          := 30
  static const Int ctrlGrid          := 31
  static const Int ctrlSpan          := 32
  static const Int ctrlVersion       := 33
  static const Int ctrlCoord         := 34
}
