...
//////////////////////////////////////////////////////////////////////////
  ...
  private Void verifyAbout(Client c)
  {
    ...
    verifyEq(about->productName,          rt.config->productName)
    verifyEq(about->productVersion,       rt.config->productVersion)
    verifyEq(about->vendorName,           rt.config->vendorName)
    verifyEq(about->vendorUri,            rt.config->vendorUri)
