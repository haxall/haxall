...
//////////////////////////////////////////////////////////////////////////
  ...
  ** Generate a list of children prototypes for the given parent dict.  If
  ** lines is non-null use it as the input (typically the string value tag
  ** of the 'children' def tag).  Or if lines is null, then return all
  ** children configured based on the parent's reflected defs.
  //@NoDoc @Axon static Dict[] protos(Dict parent, Str? lines := null)
