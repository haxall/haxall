...
//////////////////////////////////////////////////////////////////////////
  ...
  private Void doTestSysLib(Namespace ns)
  {
    ...
    // instances
    verifyEq(sys.instances.size, 31)
    ...
    verifyEq(of["doc"], "Item type for parameterized Collection/Query; target type for Ref/MultiRef")
...
//////////////////////////////////////////////////////////////////////////
  ...
  Void testInstantiate()
  {
    ...
    verifyInstantiateGraph(ns, "ashrae.g36::G36ReheatVav", [
      ...
      ["id":Ref("g"), "dis":"DischargeAirFlowSensor", "spec":Ref("ph.points.sugar::DischargeAirFlowSensor"), "point":m, "sensor":m,  "kind":"Number", "equipRef":x, "unit":"cfm","discharge":m, "air":m, "flow":m, "volume":m],
