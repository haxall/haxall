...
//////////////////////////////////////////////////////////////////////////
  ...
  Void testAutoName()
  {
    1000.times |i| { verifyAutoName(i, "_$i") }
    verifyErr(ArgErr#) { XetoUtil.autoName(1001) }
  }

  Void verifyAutoName(Int i, Str expect)
  {
    actual := XetoUtil.autoName(i)
    verifyEq(actual, expect)
    verifySame(actual, XetoUtil.autoName(i))
  }
