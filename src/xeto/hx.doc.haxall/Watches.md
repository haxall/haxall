...
to a set of records in the [hx.doc.haxall::Folio] database.  Watches are patterned
...
If using watches over the network, then use the following HTTP API ops:
  - [op:watchSub](ph.doc::Ops#watchsub)
  - [op:watchUnsub](ph.doc::Ops#watchunsub)
  - [op:watchPoll](ph.doc::Ops#watchpoll)
...
# Fantom APIs
The following [fan.hx::RuntimeWatches] and [fan.hx::Watch] APIs are used to work
